...
* ...
Further iterations will gradually get more robust and flexible.
"""
...
# Put in separate .gitignore file
Exchange = Cryptsy.Cryptsy('5df60236f3a63b2db866b8b6cb08fd088f6ed57a', '174e5e53c27872946f257605684e46e33036d2163e6c648955f3b0188249feab4d7d85a2e2cfc742')
...
def check_open_orders(open_orders):
...
def calculate_holdings(portfolio):
...
def calculate_send_hgc(coins_before_buy,coins_after_buy,portfolio,hgc_in_circulation,user_address):
...
def calculate_btc_value_portfolio(coins,portfolio):
